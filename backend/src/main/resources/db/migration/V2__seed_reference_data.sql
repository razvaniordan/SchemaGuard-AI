...
INSERT INTO countries (country_code, country_name, region_code) VALUES
  ('AT', 'Austria', 'EU'),
  ('BE', 'Belgium', 'EU'),
  ('BG', 'Bulgaria', 'EU'),
  ('HR', 'Croatia', 'EU'),
...
INSERT INTO card_types (card_type_name, description) VALUES
...
INSERT INTO banks (bank_name, country_code) VALUES
...
INSERT INTO acquiring_partners (partner_name, partner_type, country_code) VALUES
...
INSERT INTO card_networks (network_code, network_name) VALUES
  ('VISA', 'Visa'),
  ('MASTERCARD', 'Mastercard')
ON CONFLICT DO NOTHING;


INSERT INTO interchange_categories (category_name, description) VALUES
